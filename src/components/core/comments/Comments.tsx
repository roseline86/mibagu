...
function CommentForm({ postId }: CommentFormProps) {
  ...
  return (
    <div className="flex flex-col gap-4 overflow-hidden ">
      <div className="dark:border-darkgray-200 flex flex-col  gap-4 rounded-lg border p-4">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <textarea
                  className="focus:shadow-outline h-32 w-full appearance-none rounded border px-3 py-2 leading-tight  focus:outline-none dark:bg-slate-800 md:h-40"
                  id="comment"
